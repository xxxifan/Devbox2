...
public class StatusBarCompat {
    ...
    public static void setCollapsingToolbar(Activity activity, CoordinatorLayout coordinatorLayout,
        ...
        if (Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT) {
            ...
            CollapsingToolbarLayout.LayoutParams lp = (CollapsingToolbarLayout.LayoutParams) toolbar
                    .getLayoutParams();
            lp.height = (int) (getStatusBarHeight() + activity.getResources()
    ...
    private static void setKKStatusBar(Activity activity, int statusBarColor) {
        ...
        if (mStatusBarView != null && mStatusBarView.getMeasuredHeight() == getStatusBarHeight()) {
    ...
    private static int getStatusBarHeight() {
        return ViewUtils.getSystemBarHeight();
    }
}
